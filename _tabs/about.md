...
- [Writing]({{ '/writing/' | relative_url }}) for notes and public posts.
- [CV]({{ '/cv/' | relative_url }}) for a compact professional profile.
- [Contact]({{ '/contact/' | relative_url }}) for ways to reach me.
